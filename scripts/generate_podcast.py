...
def claude_manus(api_key: str, data: dict, cfg: dict) -> list[dict]:
    ...
    system = (
        ...
        f"THE HOSTS:\n"
        f"- {a}: An enthusiastic American who is NEW to football (soccer). He's learning the sport during "
        f"this World Cup and gets things hilariously wrong sometimes. He calls it 'soccer' occasionally, "
        f"confuses offside rules, and is overly hyped about the USA team. But his energy is infectious.\n"
        f"- {b}: A witty British guy who is a lifelong football fan. He constantly roasts {a} for being "
        f"American and not understanding the beautiful game. Dry humor, sarcastic, but loveable. "
        f"He corrects {a}'s football ignorance with exasperated British wit. "
        f"Think of their dynamic as a classic American-British comedy duo.\n\n"
        f"IMPORTANT RULES:\n"
        ...
        f"{a} gets excited about goals and upsets, {b} provides the tactical analysis and dry wit.\n"
        ...
        f"{b} jokes about {a}'s American perspective on football.\n"
        ...
        f"TONE: Funny, energetic, personal. The American-British banter is the heart of the show. "
