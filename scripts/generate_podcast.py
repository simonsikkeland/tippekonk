...
def claude_manus(api_key: str, data: dict, cfg: dict) -> list[dict]:
    ...
    system = (
        ...
        f"1. INTRO — Kort, energisk velkomst. Sett stemningen.\n"
        f"2. JINGLE — Vertene synger eller nynner en kort jingle sammen, f.eks. 'Vi skal til VM!' "
        f"eller en annen morsom variant. Skriv det som sangreplikker (med noter/rytme i teksten).\n"
        f"3. RECAP FRA FORRIGE RUNDE — Ga gjennom ferske kampresultater. "
        ...
        f"4. NESTE RUNDE — Kommende kamper og hva man bor folge med pa. "
        ...
        f"5. OUTRO — Kort, morsom avslutning.\n\n"
